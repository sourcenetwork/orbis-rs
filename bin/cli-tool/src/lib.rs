...
pub use commands::{
    ...
    create_ring, do_dkg, do_encrypt_secret, do_generate_reader_key, do_pre, do_sign,
    do_store_secret, fund, fund_with_signer, get_account_sequence,
    ...
    register_object_to_chain_with_config, remove_node_from_whitelist,
