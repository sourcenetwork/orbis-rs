...
// ============================================================================
// These tests spin up three orbis nodes IN-PROCESS (no Docker node images) and
// run full DKG/PRE/SIGN protocols against them via gRPC, while SourceHub runs
// in Docker (docker-compose-sourcehub-test.yml).
//
// Run with:
